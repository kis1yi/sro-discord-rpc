...
{
	return reinterpret_cast<n_wstring*(__thiscall*)(CTextStringManager*, const wchar_t*)>(0x008CCA50)(this, CodeName);
}

// Converts a name id to a readable user string
const n_wstring CTextStringManager::GetString(const n_wstring NameStrID)
{
	return reinterpret_cast<const n_wstring &(__thiscall *)(CTextStringManager *, const n_wstring &)>(0x008CC9D0)(this, NameStrID);
}